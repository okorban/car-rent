...
public class Vehicle {
    ...
    @Override //tworzenie String a z wykorzysaniem wzorców projektowych
    public String toString() {
  //      StringBuilder sb = new StringBuilder(); // gotowa klasa budująca Stringi
        return new StringBuilder()
                ...
                .append(" Rent: ")
                .append(this.isRent())
                .toString(); //z posklejanych rzeczy tworzymy stringa
